    ...
    public partial class Client : UserControl
    {
        ...
        private void uploadToDb_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                list.Add("ben ban");
                list.Add("ben mua");
                list.Add("ben van chuyen");


                string path_seller_publickey = "..\\..\\Certificate_publickey\\Seller_parties\\seller-parties.000webhostapp.com\\public_key.pem";
                string key_encrypt_with_seller_publickey = Encrypt_decrypt_key.encrypt(KEY_STRING, path_seller_publickey);
                string iv_encrypt_with_seller_publickey = Encrypt_decrypt_key.encrypt(IV_STRING, path_seller_publickey);

                string path_buyer_publickey = "..\\..\\Certificate_publickey\\Buyer_parties\\buyer-parties.000webhostapp.com";
                string key_encrypt_with_buyer_publickey = Encrypt_decrypt_key.encrypt(KEY_STRING, path_buyer_publickey);
                string iv_encrypt_with_buyer_publickey = Encrypt_decrypt_key.encrypt(IV_STRING, path_buyer_publickey);

                List<string> arrayKey = new List<string>();
                arrayKey.Add(key_encrypt_with_seller_publickey);
                arrayKey.Add(key_encrypt_with_buyer_publickey);


                List<string> arrayIv = new List<string>();
                arrayIv.Add(iv_encrypt_with_seller_publickey);
                arrayIv.Add(iv_encrypt_with_buyer_publickey);
