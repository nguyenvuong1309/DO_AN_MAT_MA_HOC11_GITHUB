...
namespace BEN_BAN
{
    public class Encrypt_decrypt_key
    {
        ...
        public static string encrypt(string plainText)   // this function encrypt using public key rsa 2048 bit.
        {
        ...
        public static string decrypt(string cipherText)         // this function using private key rsa 2048 to decrypt.
        {
